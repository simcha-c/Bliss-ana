...
task3 = Task.create(name: 'Videos have updated branding', description: '', due_date: 'Mon, 24 Sep 2018',
  column_id: backlog.id, creator_id: gus.id, completer_id: '',
  next_id: nil, prev_id: task2.id)

task2.update!(next_id: task3.id)

task4 = Task.create(name: 'Internal links across pages', description: '', due_date: 'Tues, 4 Sep 2018',
  column_id: backlog.id, creator_id: tess.id, completer_id: '',
  next_id: nil, prev_id: task3.id)

task3.update!(next_id: task4.id)

task5 = Task.create(name: 'External links across pages', description: '', due_date: 'Wed, 12 Sep 2018',
...
task6 = Task.create(name: 'CSS/HTML Validated', description: '', due_date: 'Wed, 19 Sep 2018',
...
task8 = Task.create(name: 'Format web copy into code', description: '', due_date: 'Fri, 14 Sep 2018',
  column_id: ready.id, creator_id: tess.id, assignee_id: demo_user.id, completer_id: '',
  next_id: nil, prev_id: task7.id)

task7.update!(next_id: task8.id)

task9 = Task.create(name: 'Format web copy into code', description: '',
  column_id: ready.id, creator_id: demo_user.id, completer_id: '',
...
task11 = Task.create(name: 'Mobile friendly site parallels', description: '', due_date: 'Tues, 25 Sep 2018',
  column_id: ready.id, creator_id: demo_user.id, completer_id: '',
  next_id: nil, prev_id: task10.id)

task10.update!(next_id: task11.id)

task12 = Task.create(name: 'Backend is optimized', description: '', due_date: 'Mon, 17 Sep 2018',
  column_id: progress.id, creator_id: tess.id, assignee_id: demo_user.id, completer_id: '',
  next_id: nil, prev_id: nil)

task13 = Task.create(name: 'CSS is optimized', description: '',
  column_id: progress.id, creator_id: demo_user.id, completer_id: tess.id,
  next_id: nil, prev_id: task12.id)

task12.update!(next_id: task13.id)

task14 = Task.create(name: 'Sync with Google Analytics', description: '', due_date: 'Mon, 1 Oct 2018',
...
task15 = Task.create(name: 'SEO keywords optimizations', description: '', due_date: 'Mon, 10 Sep 2018',
  column_id: progress.id, creator_id: demo_user.id, completer_id: '',
...
task17 = Task.create(name: 'Favicon renders properly', description: '', due_date: 'Tues, 4 Sep 2018',
  column_id: progress.id, creator_id: demo_user.id, assignee_id: demo_user.id, completer_id: '',
  next_id: nil, prev_id: task16.id)

task16.update!(next_id: task17.id)

task18 = Task.create(name: 'Web copy reviewed', description: '', due_date: 'Fri, 7 Sep 2018',
  column_id: progress.id, creator_id: demo_user.id, completer_id: '',
  next_id: nil, prev_id: task17.id)

task17.update!(next_id: task18.id)

task19 = Task.create(name: 'Web copy drafted', description: '', due_date: 'Thurs, 13 Sep 2018',
  column_id: done.id, creator_id: demo_user.id, assignee_id: gus.id, completer_id: '',
  next_id: nil, prev_id: nil)

task20 = Task.create(name: 'Sharing icons updated and working', description: '', due_date: 'Wed, 12 Sep 2018',
...
task21 = Task.create(name: 'Scripts and images are optimized', description: '',
  column_id: done.id, creator_id: demo_user.id, completer_id: '',
  next_id: nil, prev_id: task20.id)

task20.update!(next_id: task21.id)

task22 = Task.create(name: 'Font and image licensing', description: '', due_date: 'Tues, 18 Sep 2018',
  column_id: done.id, creator_id: demo_user.id, completer_id: '',
  next_id: nil, prev_id: task21.id)

task21.update!(next_id: task22.id)

task23 = Task.create(name: 'Web page accessibility considerations WAI-ARIA', description: '', due_date: 'Wed, 26 Sep 2018',
  column_id: done.id, creator_id: tess.id, assignee_id: gus.id, completer_id: '',
